    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(children: [
            ...
            Align(
              heightFactor: 0.2,
              child: Image.asset(AssetConfig.kBusinessCenter),
            ),
            SizedBox(height: getDeviceHeight(context) * 0.1),
            servicesDescription(
                descrip: "We as business experts can assist your organization"),
            servicesDescription(
                descrip: "With conquering issues, developing incomes"),
            servicesDescription(
                descrip:
                    "Incrementing its client base, and so forth if you have a"),
            servicesDescription(descrip: "thought that you need to adapt."),
            SizedBox(height: getDeviceHeight(context) * 0.1),
            const Text(
              "Our Project",
              style: TextStyle(
